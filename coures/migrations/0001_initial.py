# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-02-07 04:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
                ('course', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='coures.CourseList', verbose_name='\u6240\u5c5e\u8bfe\u7a0b')),
            ],
            options={
                'verbose_name': '\u8bd5\u9898\u5217\u8868',
